...
const faqs = [
  {
    ...
    answer:
      "No — it strips silent gaps throughout the entire recording, not just the leading and trailing edges. Good for cutting dead air between spoken sections in a podcast.",
  },
  {
    question: "What do threshold and minimum gap length control?",
    answer:
      "Threshold sets how quiet something has to be to count as silence. Minimum gap length sets how long that quiet stretch has to last before it's actually cut. Both have sensible defaults for most podcast and voice-memo cleanup.",
  },
  {
    question: "Will the output be shorter than the original?",
    answer:
      "Yes — gaps are cut entirely, not just muted, so the output duration will be shorter than the input.",
  },
  {
    question: "Do I need to adjust the settings?",
    answer:
      "No — both the threshold and minimum gap length have sensible defaults that work well for most podcast and voice-memo cleanup.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "No — only the silent sections themselves are cut out. The remaining audio keeps its original quality and format.",
  },
];
