      ...
      <main id="main" className="mx-auto max-w-3xl px-4 py-10 sm:py-14">
        ...
        <Prose className="mt-10">
          <p>
            ...
            attached in the first place, which is a fundamentally different, much
            harder problem than converting between two audio formats.
          </p>
          ...
          <h2 id="melody-vs-mix">Why a single melody transcribes cleaner than a full mix</h2>
          <p>
            Detecting &quot;when did a note start and at what pitch&quot; is a
            much easier job when there&apos;s one clear pitch to track at a time.
            A solo vocal line, a single instrument, or an isolated melody gives
          ...
          <h2 id="frequency-filters">
            What the minimum and maximum frequency filters are for
          </h2>
          <p>
            These two settings simply tell the detector to ignore anything outside
            a pitch range before it starts listening. Setting a minimum frequency
            filters out low rumble or bleed from a bass or kick drum that
            isn&apos;t the part you&apos;re trying to capture. Setting a maximum
            frequency filters out hiss, cymbals, or high-frequency noise.
            Narrowing the range to just where your actual melody sits reduces
            false positives from everything outside it, without touching the onset
            or frame sensitivity at all.
          </p>
          ...
          <p>
            ...
            fast, short notes in the source performance. Fast melodic runs need a
            shorter minimum than a slow, sustained vocal line.
          </p>
          ...
          <p>
            ...
            software, saving the slower work of transcribing by ear from scratch.
            And it lets you study or rework a melodic idea&apos;s timing and pitch
            independent of the original performance&apos;s tone or production.
          </p>

          <h2 id="limitations">Where it still struggles</h2>
          <p>
            ...
            results come from a single clear instrument or vocal melody with
            minimal competing sound in the same frequency range.
          </p>
          ...
          <p>
            ...
            <Link href="/audio-to-midi">Audio to MIDI Converter</Link> and expand
            Advanced Settings.
          </p>
        </Prose>
