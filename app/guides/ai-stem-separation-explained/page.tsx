      ...
      <main id="main" className="mx-auto max-w-3xl px-4 py-10 sm:py-14">
        ...
        <Prose className="mt-10">
          ...
          <p>
            ...
            instead of one boundary to draw, it&apos;s drawing three, and some
            instruments sit closer to each other in character than a voice does to
            any of them.
          </p>

          <h2 id="bass-and-drums">Why bass and drums are the tricky pair</h2>
          <p>
            ...
            the model relies on to identify a hit as &quot;drums&quot; rather than
            part of the other stem.
          </p>
          ...
          <p>
            ...
            &quot;other&quot; might be comparatively sparse. What ends up in it
            depends entirely on how the source track is arranged.
          </p>

          <h2 id="standard-vs-studio">Standard vs. Studio Quality</h2>
          <p>
            Standard mode runs a single pass of the separation model and finishes
            in under a minute on our GPU-accelerated infrastructure. Studio
